...
def Inception_C(Input):
    ...
    output = merge([path1_a, path2_a, path3, path4], mode='concat', concat_axis=-1)
    return output
...
x = Dropout(0.2)(x)
x=Flatten()(x)
predictions = Dense(nb_classes, activation='softmax',init='uniform')(x)
model = Model(input=inputs, output=predictions)
print(model.summary())
'''
Total params: 688,825
Trainable params: 688,825
